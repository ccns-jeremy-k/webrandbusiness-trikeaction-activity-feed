...
= 3.2.9 =
* Tweak - PhotoSwipe, Plupload and Fancybox library updated
* Fix - Fixed bbPress and activity PhotoSwipe actions
* Fix - Media upload icon missing in latest Android mobiles
* Fix - Album popup design issue
* Fix - In activity, first image looks blurry in mobile
* Fix - Fixed title styling in media popup
* Fix - Added caption for image popup
* Fix - Fix caption of img tags in activity photos
* Fix - Fixed broken uploader button issue
* Fix - Fixed various UI issues after PhotoSwipe, Plupload and, Fancybox library update
* Fix - Comment redirection not opening comment box on popup


= 3.2.8 =
* Fix - Removed the term 'You' if its current users activity

= 3.2.7 =
* Fix - Images were not appearing on activity page after BuddyPress 4.3.0 update
* Fix - Media upload button not working for nouveau template
* Fix - Create album button fix for nouveau template
* Fix - Some php notices and warnings fixes
